...
<body>
    <div class="wrapper flex items-center justify-center w-[100vw] h-[100vh]">
        <div class="login max-w-[500px] w-[400px] min-h-[300px] max-w-[500px] border rounded-2xl border-gray-300 shadow-2xl p-5">
            ...
            <form action="/login" method="POST" class="flex flex-col my-5 gap-4">
                @csrf
                ...
                <div class="register-page-link">
                    <p class="text-[12px]">Don't have any account <a href="/register" class="text-red-500 underline">Register</a></p>
                </div>
            </form>
        </div>
    </div>
